...
def define_extensions(cythonize=False):
    ...
    if cythonize:
        glove_corpus = "baseline/pytorch/embed/corpus_cython.pyx"
    else:
        glove_corpus = "baseline/pytorch/embed/corpus_cython.cpp"

    return [Extension("baseline.pytorch.embed.corpus_cython", [glove_corpus],
                      language='C++',
                      libraries=["stdc++"],
