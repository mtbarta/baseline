...
/* BEGIN: Cython Metadata
{
    "distutils": {
        ...
        "name": "baseline.pytorch.embed.corpus_cython",
        "sources": [
            "baseline/pytorch/embed/corpus_cython.pyx"
        ]
    },
    "module_name": "baseline.pytorch.embed.corpus_cython"
}
END: Cython Metadata */
...
#define __PYX_HAVE__baseline__pytorch__embed__corpus_cython
#define __PYX_HAVE_API__baseline__pytorch__embed__corpus_cython
/* Early includes */
#include <string.h>
#include <stdlib.h>
#include "ios"
...
struct __pyx_t_8baseline_7pytorch_5embed_13corpus_cython_SparseRowMatrix;

/* "baseline/pytorch/embed/corpus_cython.pyx":41
 * 
 * 
...
/* Module declarations from 'baseline.pytorch.embed.corpus_cython' */
...
static CYTHON_INLINE int __pyx_f_8baseline_7pytorch_5embed_13corpus_cython_int_min(int, int); /*proto*/
static int __pyx_f_8baseline_7pytorch_5embed_13corpus_cython_binary_search(int *, int, int, int, int); /*proto*/
static struct __pyx_t_8baseline_7pytorch_5embed_13corpus_cython_SparseRowMatrix *__pyx_f_8baseline_7pytorch_5embed_13corpus_cython_new_matrix(void); /*proto*/
static void __pyx_f_8baseline_7pytorch_5embed_13corpus_cython_free_matrix(struct __pyx_t_8baseline_7pytorch_5embed_13corpus_cython_SparseRowMatrix *); /*proto*/
static void __pyx_f_8baseline_7pytorch_5embed_13corpus_cython_increment_matrix(struct __pyx_t_8baseline_7pytorch_5embed_13corpus_cython_SparseRowMatrix *, int, int, float); /*proto*/
static int __pyx_f_8baseline_7pytorch_5embed_13corpus_cython_matrix_nnz(struct __pyx_t_8baseline_7pytorch_5embed_13corpus_cython_SparseRowMatrix *); /*proto*/
static PyObject *__pyx_f_8baseline_7pytorch_5embed_13corpus_cython_matrix_to_coo(struct __pyx_t_8baseline_7pytorch_5embed_13corpus_cython_SparseRowMatrix *, int); /*proto*/
static int __pyx_f_8baseline_7pytorch_5embed_13corpus_cython_words_to_ids(PyObject *, std::vector<int>  &, PyObject *, int, int); /*proto*/
...
#define __Pyx_MODULE_NAME "baseline.pytorch.embed.corpus_cython"
extern int __pyx_module_is_main_baseline__pytorch__embed__corpus_cython;
int __pyx_module_is_main_baseline__pytorch__embed__corpus_cython = 0;

/* Implementation of 'baseline.pytorch.embed.corpus_cython' */
...
static const char __pyx_k_baseline_pytorch_embed_corpus_cy[] = "baseline/pytorch/embed/corpus_cython.pyx";
static const char __pyx_k_got_differing_extents_in_dimensi[] = "got differing extents in dimension %d (got %d and %d)";
static const char __pyx_k_no_default___reduce___due_to_non[] = "no default __reduce__ due to non-trivial __cinit__";
static const char __pyx_k_unable_to_allocate_shape_and_str[] = "unable to allocate shape and strides.";
static const char __pyx_k_baseline_pytorch_embed_corpus_cy_2[] = "baseline.pytorch.embed.corpus_cython";
...
static PyObject *__pyx_kp_s_baseline_pytorch_embed_corpus_cy;
static PyObject *__pyx_n_s_baseline_pytorch_embed_corpus_cy_2;
...
static PyObject *__pyx_pf_8baseline_7pytorch_5embed_13corpus_cython_construct_cooccurrence_matrix(CYTHON_UNUSED PyObject *__pyx_self, PyObject *__pyx_v_corpus, PyObject *__pyx_v_dictionary, int __pyx_v_supplied, int __pyx_v_window_size, int __pyx_v_ignore_missing); /* proto */
...
/* "baseline/pytorch/embed/corpus_cython.pyx":14
 * 
 * 
...
static CYTHON_INLINE int __pyx_f_8baseline_7pytorch_5embed_13corpus_cython_int_min(int __pyx_v_a, int __pyx_v_b) {
  int __pyx_r;
  int __pyx_t_1;
...
/* "baseline/pytorch/embed/corpus_cython.pyx":17
 * 
 * 
...
static int __pyx_f_8baseline_7pytorch_5embed_13corpus_cython_binary_search(int *__pyx_v_vec, int __pyx_v_size, int __pyx_v_first, int __pyx_v_last, int __pyx_v_x) {
  int __pyx_v_mid;
  int __pyx_r;
  int __pyx_t_1;

  /* "baseline/pytorch/embed/corpus_cython.pyx":24
 *     cdef int mid
 * 
 *     while (first < last):             # <<<<<<<<<<<<<<
 *         mid = (first + last) / 2
 ...
 */
  while (1) {
    ...
    /* "baseline/pytorch/embed/corpus_cython.pyx":25
 * 
 *     while (first < last):
 *         mid = (first + last) / 2             # <<<<<<<<<<<<<<
 *         if (vec[mid] == x):
 ...
 */
    ...
    /* "baseline/pytorch/embed/corpus_cython.pyx":26
 *     while (first < last):
 *         mid = (first + last) / 2
 *         if (vec[mid] == x):             # <<<<<<<<<<<<<<
 *             return mid
 ...
 */
    ...
    if (__pyx_t_1) {
      ...
      /* "baseline/pytorch/embed/corpus_cython.pyx":27
 *         mid = (first + last) / 2
 *         if (vec[mid] == x):
 *             return mid             # <<<<<<<<<<<<<<
 *         elif vec[mid] > x:
 ...
 */
    ...
    /* "baseline/pytorch/embed/corpus_cython.pyx":28
 *         if (vec[mid] == x):
 *             return mid
 *         elif vec[mid] > x:             # <<<<<<<<<<<<<<
 *             last = mid - 1
 ...
 */
    ...
    if (__pyx_t_1) {
      ...
      /* "baseline/pytorch/embed/corpus_cython.pyx":29
 *             return mid
 *         elif vec[mid] > x:
 *             last = mid - 1             # <<<<<<<<<<<<<<
 *         else:
 ...
 */
    ...
    /* "baseline/pytorch/embed/corpus_cython.pyx":31
 *             last = mid - 1
 *         else:
 *             first = mid + 1             # <<<<<<<<<<<<<<
 * 
 ...
 */
  ...
  /* "baseline/pytorch/embed/corpus_cython.pyx":33
 *             first = mid + 1
 * 
 *     if (first == size):             # <<<<<<<<<<<<<<
 *         return first
 ...
 */
  ...
  if (__pyx_t_1) {
    ...
    /* "baseline/pytorch/embed/corpus_cython.pyx":34
 * 
 *     if (first == size):
 *         return first             # <<<<<<<<<<<<<<
 *     elif vec[first] > x:
 ...
 */
  ...
  /* "baseline/pytorch/embed/corpus_cython.pyx":35
 *     if (first == size):
 *         return first
 *     elif vec[first] > x:             # <<<<<<<<<<<<<<
 *         return first
 ...
 */
  ...
  if (__pyx_t_1) {
    ...
    /* "baseline/pytorch/embed/corpus_cython.pyx":36
 *         return first
 *     elif vec[first] > x:
 *         return first             # <<<<<<<<<<<<<<
 *     else:
 ...
 */
  ...
  /* "baseline/pytorch/embed/corpus_cython.pyx":38
 *         return first
 *     else:
 *         return first + 1             # <<<<<<<<<<<<<<
 * 
...
/* "baseline/pytorch/embed/corpus_cython.pyx":46
 * 
 * 
...
static struct __pyx_t_8baseline_7pytorch_5embed_13corpus_cython_SparseRowMatrix *__pyx_f_8baseline_7pytorch_5embed_13corpus_cython_new_matrix(void) {
  struct __pyx_t_8baseline_7pytorch_5embed_13corpus_cython_SparseRowMatrix *__pyx_v_mat;
  struct __pyx_t_8baseline_7pytorch_5embed_13corpus_cython_SparseRowMatrix *__pyx_r;
  ...
  /* "baseline/pytorch/embed/corpus_cython.pyx":53
 ...
 *     if mat == NULL:
 */
  __pyx_v_mat = ((struct __pyx_t_8baseline_7pytorch_5embed_13corpus_cython_SparseRowMatrix *)malloc((sizeof(struct __pyx_t_8baseline_7pytorch_5embed_13corpus_cython_SparseRowMatrix))));

  /* "baseline/pytorch/embed/corpus_cython.pyx":55
 *     mat = <SparseRowMatrix*>malloc(sizeof(SparseRowMatrix))
 * 
 *     if mat == NULL:             # <<<<<<<<<<<<<<
 *         raise MemoryError()
 ...
 */
  ...
  if (unlikely(__pyx_t_1)) {
    ...
    /* "baseline/pytorch/embed/corpus_cython.pyx":56
 * 
 *     if mat == NULL:
 *         raise MemoryError()             # <<<<<<<<<<<<<<
 * 
 ...
 */
  ...
  /* "baseline/pytorch/embed/corpus_cython.pyx":58
 *         raise MemoryError()
 * 
 *     mat.indices = new vector[vector[int]]()             # <<<<<<<<<<<<<<
 ...
 */
  ...
  /* "baseline/pytorch/embed/corpus_cython.pyx":59
 * 
 *     mat.indices = new vector[vector[int]]()
 *     mat.data = new vector[vector[float]]()             # <<<<<<<<<<<<<<
 * 
 ...
 */
  ...
  /* "baseline/pytorch/embed/corpus_cython.pyx":61
 *     mat.data = new vector[vector[float]]()
 * 
 *     return mat             # <<<<<<<<<<<<<<
 * 
 ...
 */
  ...
  /* function exit code */
  __pyx_L1_error:;
  __Pyx_WriteUnraisable("baseline.pytorch.embed.corpus_cython.new_matrix", __pyx_clineno, __pyx_lineno, __pyx_filename, 1, 0);
  __pyx_r = 0;
  __pyx_L0:;
...
/* "baseline/pytorch/embed/corpus_cython.pyx":64
 * 
 * 
...
static void __pyx_f_8baseline_7pytorch_5embed_13corpus_cython_free_matrix(struct __pyx_t_8baseline_7pytorch_5embed_13corpus_cython_SparseRowMatrix *__pyx_v_mat) {
  int __pyx_v_i;
  int __pyx_v_rows;
  int __pyx_t_1;
  int __pyx_t_2;
  ...
  /* "baseline/pytorch/embed/corpus_cython.pyx":70
 * 
 *     cdef int i
 ...
 */
  ...
  /* "baseline/pytorch/embed/corpus_cython.pyx":72
 *     cdef int rows = mat.indices.size()
 * 
 *     for i in range(rows):             # <<<<<<<<<<<<<<
 ...
 */
  ...
  for (__pyx_t_3 = 0; __pyx_t_3 < __pyx_t_2; __pyx_t_3+=1) {
    ...
    /* "baseline/pytorch/embed/corpus_cython.pyx":73
 * 
 *     for i in range(rows):
 *         deref(mat.indices)[i].clear()             # <<<<<<<<<<<<<<
 *         deref(mat.data)[i].clear()
 ...
 */
    ...
    /* "baseline/pytorch/embed/corpus_cython.pyx":74
 *     for i in range(rows):
 *         deref(mat.indices)[i].clear()
 *         deref(mat.data)[i].clear()             # <<<<<<<<<<<<<<
 * 
 ...
 */
  ...
  /* "baseline/pytorch/embed/corpus_cython.pyx":76
 *         deref(mat.data)[i].clear()
 * 
 *     del mat.indices             # <<<<<<<<<<<<<<
 *     del mat.data
 ...
 */
  ...
  /* "baseline/pytorch/embed/corpus_cython.pyx":77
 * 
 *     del mat.indices
 *     del mat.data             # <<<<<<<<<<<<<<
 * 
 ...
 */
  ...
  /* "baseline/pytorch/embed/corpus_cython.pyx":79
 *     del mat.data
 * 
 *     free(mat)             # <<<<<<<<<<<<<<
 * 
...
/* "baseline/pytorch/embed/corpus_cython.pyx":82
 * 
 * 
...
static void __pyx_f_8baseline_7pytorch_5embed_13corpus_cython_increment_matrix(struct __pyx_t_8baseline_7pytorch_5embed_13corpus_cython_SparseRowMatrix *__pyx_v_mat, int __pyx_v_row, int __pyx_v_col, float __pyx_v_increment) {
  ...
  /* "baseline/pytorch/embed/corpus_cython.pyx":93
 * 
 ...
 */
  while (1) {
    ...
    /* "baseline/pytorch/embed/corpus_cython.pyx":94
 *     # Add new row if necessary
 *     while row >= mat.indices.size():
 *         mat.indices.push_back(vector[int]())             # <<<<<<<<<<<<<<
 *         mat.data.push_back(vector[float]())
 ...
 */
    ...
    /* "baseline/pytorch/embed/corpus_cython.pyx":95
 *     while row >= mat.indices.size():
 *         mat.indices.push_back(vector[int]())
 *         mat.data.push_back(vector[float]())             # <<<<<<<<<<<<<<
 * 
 ...
 */
  ...
  /* "baseline/pytorch/embed/corpus_cython.pyx":97
 *         mat.data.push_back(vector[float]())
 * 
 *     row_indices = &(deref(mat.indices)[row])             # <<<<<<<<<<<<<<
 ...
 */
  ...
  /* "baseline/pytorch/embed/corpus_cython.pyx":98
 * 
 *     row_indices = &(deref(mat.indices)[row])
 *     row_data = &(deref(mat.data)[row])             # <<<<<<<<<<<<<<
 * 
 ...
 */
  ...
  /* "baseline/pytorch/embed/corpus_cython.pyx":102
 *     # Find the column element, or the position where
 ...
 */
  ...
  if (__pyx_t_1) {
    ...
    /* "baseline/pytorch/embed/corpus_cython.pyx":103
 *     # a new element should be inserted
 *     if row_indices.size() == 0:
 *         idx = 0             # <<<<<<<<<<<<<<
 *     else:
 ...
 */
  ...
  /* "baseline/pytorch/embed/corpus_cython.pyx":105
 *         idx = 0
 *     else:
 *         idx = binary_search(&(deref(row_indices)[0]), row_indices.size(),             # <<<<<<<<<<<<<<
 ...
 */
  /*else*/ {
    ...
    /* "baseline/pytorch/embed/corpus_cython.pyx":106
 *     else:
 *         idx = binary_search(&(deref(row_indices)[0]), row_indices.size(),
 *                             0, row_indices.size(), col)             # <<<<<<<<<<<<<<
 * 
 ...
 */
    __pyx_v_idx = __pyx_f_8baseline_7pytorch_5embed_13corpus_cython_binary_search((&((*__pyx_v_row_indices)[0])), __pyx_v_row_indices->size(), 0, __pyx_v_row_indices->size(), __pyx_v_col);
  }
  __pyx_L5:;

  /* "baseline/pytorch/embed/corpus_cython.pyx":109
 * 
 *     # Element to be added at the end
 ...
 */
  ...
  if (__pyx_t_1) {
    ...
    /* "baseline/pytorch/embed/corpus_cython.pyx":110
 *     # Element to be added at the end
 *     if idx == row_indices.size():
 *         row_indices.insert(row_indices.begin() + idx, col)             # <<<<<<<<<<<<<<
 *         row_data.insert(row_data.begin() + idx, increment)
 ...
 */
    ...
    /* "baseline/pytorch/embed/corpus_cython.pyx":111
 *     if idx == row_indices.size():
 *         row_indices.insert(row_indices.begin() + idx, col)
 *         row_data.insert(row_data.begin() + idx, increment)             # <<<<<<<<<<<<<<
 *         return
 ...
 */
    ...
    /* "baseline/pytorch/embed/corpus_cython.pyx":112
 *         row_indices.insert(row_indices.begin() + idx, col)
 *         row_data.insert(row_data.begin() + idx, increment)
 *         return             # <<<<<<<<<<<<<<
 * 
 ...
 */
  ...
  /* "baseline/pytorch/embed/corpus_cython.pyx":114
 *         return
 * 
 *     col_at_idx = deref(row_indices)[idx]             # <<<<<<<<<<<<<<
 * 
 ...
 */
  ...
  /* "baseline/pytorch/embed/corpus_cython.pyx":116
 *     col_at_idx = deref(row_indices)[idx]
 * 
 *     if col_at_idx == col:             # <<<<<<<<<<<<<<
 ...
 */
  ...
  if (__pyx_t_1) {
    ...
    /* "baseline/pytorch/embed/corpus_cython.pyx":118
 *     if col_at_idx == col:
 *         # Element to be incremented
 *         deref(row_data)[idx] = deref(row_data)[idx] + increment             # <<<<<<<<<<<<<<
 *     else:
 ...
 */
  ...
  /* "baseline/pytorch/embed/corpus_cython.pyx":121
 *     else:
 *         # Element to be inserted
 *         row_indices.insert(row_indices.begin() + idx, col)             # <<<<<<<<<<<<<<
 *         row_data.insert(row_data.begin() + idx, increment)
 ...
 */
  /*else*/ {
    ...
    /* "baseline/pytorch/embed/corpus_cython.pyx":122
 *         # Element to be inserted
 *         row_indices.insert(row_indices.begin() + idx, col)
 *         row_data.insert(row_data.begin() + idx, increment)             # <<<<<<<<<<<<<<
 * 
 ...
 */
  ...
  goto __pyx_L0;
  __pyx_L1_error:;
  __Pyx_WriteUnraisable("baseline.pytorch.embed.corpus_cython.increment_matrix", __pyx_clineno, __pyx_lineno, __pyx_filename, 1, 1);
  __pyx_L0:;
}

/* "baseline/pytorch/embed/corpus_cython.pyx":125
 * 
 * 
...
static int __pyx_f_8baseline_7pytorch_5embed_13corpus_cython_matrix_nnz(struct __pyx_t_8baseline_7pytorch_5embed_13corpus_cython_SparseRowMatrix *__pyx_v_mat) {
  int __pyx_v_i;
  int __pyx_v_size;
  int __pyx_r;
  ...
  /* "baseline/pytorch/embed/corpus_cython.pyx":131
 * 
 *     cdef int i
 *     cdef int size = 0             # <<<<<<<<<<<<<<
 * 
 ...
 */
  ...
  /* "baseline/pytorch/embed/corpus_cython.pyx":133
 *     cdef int size = 0
 * 
 *     for i in range(mat.indices.size()):             # <<<<<<<<<<<<<<
 ...
 */
  ...
  for (__pyx_t_3 = 0; __pyx_t_3 < __pyx_t_2; __pyx_t_3+=1) {
    ...
    /* "baseline/pytorch/embed/corpus_cython.pyx":134
 * 
 *     for i in range(mat.indices.size()):
 *         size += deref(mat.indices)[i].size()             # <<<<<<<<<<<<<<
 * 
 ...
 */
  ...
  /* "baseline/pytorch/embed/corpus_cython.pyx":136
 *         size += deref(mat.indices)[i].size()
 * 
 *     return size             # <<<<<<<<<<<<<<
 * 
...
/* "baseline/pytorch/embed/corpus_cython.pyx":139
 * 
 * 
...
static PyObject *__pyx_f_8baseline_7pytorch_5embed_13corpus_cython_matrix_to_coo(struct __pyx_t_8baseline_7pytorch_5embed_13corpus_cython_SparseRowMatrix *__pyx_v_mat, int __pyx_v_shape) {
  int __pyx_v_i;
  int __pyx_v_j;
  int __pyx_v_row;
  int __pyx_v_rows;
  ...
  /* "baseline/pytorch/embed/corpus_cython.pyx":147
 *     cdef int row
 *     cdef int col
 *     cdef int rows = mat.indices.size()             # <<<<<<<<<<<<<<
 ...
 */
  ...
  /* "baseline/pytorch/embed/corpus_cython.pyx":148
 *     cdef int col
 *     cdef int rows = mat.indices.size()
 *     cdef int no_collocations = matrix_nnz(mat)             # <<<<<<<<<<<<<<
 * 
 ...
 */
  __pyx_v_no_collocations = __pyx_f_8baseline_7pytorch_5embed_13corpus_cython_matrix_nnz(__pyx_v_mat);

  /* "baseline/pytorch/embed/corpus_cython.pyx":151
 * 
 *     # Create the constituent numpy arrays.
 ...
 */
  ...
  /* "baseline/pytorch/embed/corpus_cython.pyx":152
 *     # Create the constituent numpy arrays.
 *     row_np = np.empty(no_collocations, dtype=np.int32)
 *     col_np = np.empty(no_collocations, dtype=np.int32)             # <<<<<<<<<<<<<<
 *     data_np = np.empty(no_collocations, dtype=np.float64)
 ...
 */
  ...
  /* "baseline/pytorch/embed/corpus_cython.pyx":153
 *     row_np = np.empty(no_collocations, dtype=np.int32)
 *     col_np = np.empty(no_collocations, dtype=np.int32)
 *     data_np = np.empty(no_collocations, dtype=np.float64)             # <<<<<<<<<<<<<<
 *     cdef int[:] row_view = row_np
 ...
 */
  ...
  /* "baseline/pytorch/embed/corpus_cython.pyx":154
 *     col_np = np.empty(no_collocations, dtype=np.int32)
 *     data_np = np.empty(no_collocations, dtype=np.float64)
 *     cdef int[:] row_view = row_np             # <<<<<<<<<<<<<<
 *     cdef int[:] col_view = col_np
 ...
 */
  ...
  /* "baseline/pytorch/embed/corpus_cython.pyx":155
 *     data_np = np.empty(no_collocations, dtype=np.float64)
 *     cdef int[:] row_view = row_np
 *     cdef int[:] col_view = col_np             # <<<<<<<<<<<<<<
 *     cdef double[:] data_view = data_np
 ...
 */
  ...
  /* "baseline/pytorch/embed/corpus_cython.pyx":156
 *     cdef int[:] row_view = row_np
 *     cdef int[:] col_view = col_np
 *     cdef double[:] data_view = data_np             # <<<<<<<<<<<<<<
 * 
 ...
 */
  ...
  /* "baseline/pytorch/embed/corpus_cython.pyx":158
 *     cdef double[:] data_view = data_np
 * 
 *     j = 0             # <<<<<<<<<<<<<<
 * 
 ...
 */
  ...
  /* "baseline/pytorch/embed/corpus_cython.pyx":160
 *     j = 0
 * 
 *     for row in range(rows):             # <<<<<<<<<<<<<<
 ...
 */
  ...
  for (__pyx_t_10 = 0; __pyx_t_10 < __pyx_t_9; __pyx_t_10+=1) {
    ...
    /* "baseline/pytorch/embed/corpus_cython.pyx":161
 * 
 *     for row in range(rows):
 *         for i in range(deref(mat.indices)[row].size()):             # <<<<<<<<<<<<<<
 * 
 ...
 */
    ...
    for (__pyx_t_13 = 0; __pyx_t_13 < __pyx_t_12; __pyx_t_13+=1) {
      ...
      /* "baseline/pytorch/embed/corpus_cython.pyx":163
 *         for i in range(deref(mat.indices)[row].size()):
 * 
 *             row_view[j] = row             # <<<<<<<<<<<<<<
 ...
 */
      ...
      *((int *) ( /* dim=0 */ (__pyx_v_row_view.data + __pyx_t_14 * __pyx_v_row_view.strides[0]) )) = __pyx_v_row;
      ...
      /* "baseline/pytorch/embed/corpus_cython.pyx":164
 * 
 *             row_view[j] = row
 *             col_view[j] = deref(mat.indices)[row][i]             # <<<<<<<<<<<<<<
 *             data_view[j] = deref(mat.data)[row][i]
 ...
 */
      ...
      *((int *) ( /* dim=0 */ (__pyx_v_col_view.data + __pyx_t_15 * __pyx_v_col_view.strides[0]) )) = (((*__pyx_v_mat->indices)[__pyx_v_row])[__pyx_v_i]);
      ...
      /* "baseline/pytorch/embed/corpus_cython.pyx":165
 *             row_view[j] = row
 *             col_view[j] = deref(mat.indices)[row][i]
 *             data_view[j] = deref(mat.data)[row][i]             # <<<<<<<<<<<<<<
 * 
 ...
 */
      ...
      *((double *) ( /* dim=0 */ (__pyx_v_data_view.data + __pyx_t_16 * __pyx_v_data_view.strides[0]) )) = (((*__pyx_v_mat->data)[__pyx_v_row])[__pyx_v_i]);
      ...
      /* "baseline/pytorch/embed/corpus_cython.pyx":167
 *             data_view[j] = deref(mat.data)[row][i]
 * 
 *             j += 1             # <<<<<<<<<<<<<<
 * 
 ...
 */
  ...
  /* "baseline/pytorch/embed/corpus_cython.pyx":170
 * 
 *     # Create and return the matrix.
 ...
 */
  ...
  /* "baseline/pytorch/embed/corpus_cython.pyx":171
 *     # Create and return the matrix.
 *     return sp.coo_matrix((data_np, (row_np, col_np)),
 *                          shape=(shape,             # <<<<<<<<<<<<<<
 *                                 shape),
 ...
 */
  ...
  /* "baseline/pytorch/embed/corpus_cython.pyx":172
 *     return sp.coo_matrix((data_np, (row_np, col_np)),
 *                          shape=(shape,
 *                                 shape),             # <<<<<<<<<<<<<<
 *                          dtype=np.float64)
 ...
 */
  ...
  /* "baseline/pytorch/embed/corpus_cython.pyx":173
 *                          shape=(shape,
 *                                 shape),
 *                          dtype=np.float64)             # <<<<<<<<<<<<<<
 * 
 ...
 */
  ...
  __Pyx_AddTraceback("baseline.pytorch.embed.corpus_cython.matrix_to_coo", __pyx_clineno, __pyx_lineno, __pyx_filename);
  __pyx_r = 0;
  __pyx_L0:;
...
/* "baseline/pytorch/embed/corpus_cython.pyx":176
 * 
 * 
...
static int __pyx_f_8baseline_7pytorch_5embed_13corpus_cython_words_to_ids(PyObject *__pyx_v_words, std::vector<int>  &__pyx_v_word_ids, PyObject *__pyx_v_dictionary, int __pyx_v_supplied, int __pyx_v_ignore_missing) {
  int __pyx_v_word_id;
  ...
  /* "baseline/pytorch/embed/corpus_cython.pyx":195
 *     cdef int word_id
 * 
 *     word_ids.resize(0)             # <<<<<<<<<<<<<<
 * 
 ...
 */
  ...
  /* "baseline/pytorch/embed/corpus_cython.pyx":197
 *     word_ids.resize(0)
 * 
 *     if supplied == 1:             # <<<<<<<<<<<<<<
 *         for word in words:
 ...
 */
  ...
  if (__pyx_t_1) {
    ...
    /* "baseline/pytorch/embed/corpus_cython.pyx":198
 * 
 *     if supplied == 1:
 *         for word in words:             # <<<<<<<<<<<<<<
 *             # Raise an error if the word
 ...
 */
    ...
    for (;;) {
      ...
      /* "baseline/pytorch/embed/corpus_cython.pyx":202
 *             # is missing from the supplied
 *             # dictionary.
 ...
 */
      ...
      /* "baseline/pytorch/embed/corpus_cython.pyx":203
 *             # dictionary.
 *             word_id = dictionary.get(word, -1)
 *             if word_id == -1 and ignore_missing == 0:             # <<<<<<<<<<<<<<
 *                 return -1
 ...
 */
      ...
      if (__pyx_t_1) {
        ...
        /* "baseline/pytorch/embed/corpus_cython.pyx":204
 *             word_id = dictionary.get(word, -1)
 *             if word_id == -1 and ignore_missing == 0:
 *                 return -1             # <<<<<<<<<<<<<<
 * 
 ...
 */
      ...
      /* "baseline/pytorch/embed/corpus_cython.pyx":206
 *                 return -1
 * 
 *             word_ids.push_back(word_id)             # <<<<<<<<<<<<<<
 * 
 ...
 */
  ...
  /* "baseline/pytorch/embed/corpus_cython.pyx":209
 * 
 *     else:
 *         for word in words:             # <<<<<<<<<<<<<<
 ...
 */
  /*else*/ {
    ...
    for (;;) {
      ...
      /* "baseline/pytorch/embed/corpus_cython.pyx":210
 *     else:
 *         for word in words:
 *             word_id = dictionary.setdefault(word,             # <<<<<<<<<<<<<<
 *                                             len(dictionary))
 ...
 */
      ...
      /* "baseline/pytorch/embed/corpus_cython.pyx":211
 *         for word in words:
 *             word_id = dictionary.setdefault(word,
 *                                             len(dictionary))             # <<<<<<<<<<<<<<
 *             word_ids.push_back(word_id)
 ...
 */
      ...
      /* "baseline/pytorch/embed/corpus_cython.pyx":212
 *             word_id = dictionary.setdefault(word,
 *                                             len(dictionary))
 *             word_ids.push_back(word_id)             # <<<<<<<<<<<<<<
 * 
 ...
 */
  ...
  /* "baseline/pytorch/embed/corpus_cython.pyx":214
 *             word_ids.push_back(word_id)
 * 
 *     return 0             # <<<<<<<<<<<<<<
 * 
 ...
 */
  ...
  __Pyx_WriteUnraisable("baseline.pytorch.embed.corpus_cython.words_to_ids", __pyx_clineno, __pyx_lineno, __pyx_filename, 1, 0);
  __pyx_r = 0;
  __pyx_L0:;
...
/* "baseline/pytorch/embed/corpus_cython.pyx":217
 * 
 * 
...
/* Python wrapper */
static PyObject *__pyx_pw_8baseline_7pytorch_5embed_13corpus_cython_1construct_cooccurrence_matrix(PyObject *__pyx_self, PyObject *__pyx_args, PyObject *__pyx_kwds); /*proto*/
static char __pyx_doc_8baseline_7pytorch_5embed_13corpus_cython_construct_cooccurrence_matrix[] = "\n    Construct the word-id dictionary and cooccurrence matrix for\n    a given corpus, using a given window size.\n\n    Returns the dictionary and a scipy.sparse COO cooccurrence matrix.\n    ";
static PyMethodDef __pyx_mdef_8baseline_7pytorch_5embed_13corpus_cython_1construct_cooccurrence_matrix = {"construct_cooccurrence_matrix", (PyCFunction)__pyx_pw_8baseline_7pytorch_5embed_13corpus_cython_1construct_cooccurrence_matrix, METH_VARARGS|METH_KEYWORDS, __pyx_doc_8baseline_7pytorch_5embed_13corpus_cython_construct_cooccurrence_matrix};
static PyObject *__pyx_pw_8baseline_7pytorch_5embed_13corpus_cython_1construct_cooccurrence_matrix(PyObject *__pyx_self, PyObject *__pyx_args, PyObject *__pyx_kwds) {
  ...
  __pyx_L3_error:;
  __Pyx_AddTraceback("baseline.pytorch.embed.corpus_cython.construct_cooccurrence_matrix", __pyx_clineno, __pyx_lineno, __pyx_filename);
  __Pyx_RefNannyFinishContext();
  return NULL;
  __pyx_L4_argument_unpacking_done:;
  __pyx_r = __pyx_pf_8baseline_7pytorch_5embed_13corpus_cython_construct_cooccurrence_matrix(__pyx_self, __pyx_v_corpus, __pyx_v_dictionary, __pyx_v_supplied, __pyx_v_window_size, __pyx_v_ignore_missing);
...
static PyObject *__pyx_pf_8baseline_7pytorch_5embed_13corpus_cython_construct_cooccurrence_matrix(CYTHON_UNUSED PyObject *__pyx_self, PyObject *__pyx_v_corpus, PyObject *__pyx_v_dictionary, int __pyx_v_supplied, int __pyx_v_window_size, int __pyx_v_ignore_missing) {
  struct __pyx_t_8baseline_7pytorch_5embed_13corpus_cython_SparseRowMatrix *__pyx_v_matrix;
  ...
  /* "baseline/pytorch/embed/corpus_cython.pyx":227
 * 
 ...
 */
  __pyx_v_matrix = __pyx_f_8baseline_7pytorch_5embed_13corpus_cython_new_matrix();

  /* "baseline/pytorch/embed/corpus_cython.pyx":237
 ...
 */
  ...
  /* "baseline/pytorch/embed/corpus_cython.pyx":240
 * 
 *     # Iterate over the corpus.
 *     for words in corpus:             # <<<<<<<<<<<<<<
 * 
 ...
 */
  ...
  for (;;) {
    ...
    /* "baseline/pytorch/embed/corpus_cython.pyx":243
 * 
 *         # Convert words to a numeric vector.
 ...
 *         if error == -1:
 */
    __pyx_v_error = __pyx_f_8baseline_7pytorch_5embed_13corpus_cython_words_to_ids(__pyx_v_words, __pyx_v_word_ids, __pyx_v_dictionary, __pyx_v_supplied, __pyx_v_ignore_missing);

    /* "baseline/pytorch/embed/corpus_cython.pyx":245
 *         error = words_to_ids(words, word_ids, dictionary,
 *                              supplied, ignore_missing)
 *         if error == -1:             # <<<<<<<<<<<<<<
 ...
 */
    ...
    if (unlikely(__pyx_t_5)) {
      ...
      /* "baseline/pytorch/embed/corpus_cython.pyx":246
 *                              supplied, ignore_missing)
 *         if error == -1:
 *             raise KeyError('Word missing from dictionary')             # <<<<<<<<<<<<<<
 * 
 ...
 */
    ...
    /* "baseline/pytorch/embed/corpus_cython.pyx":248
 *             raise KeyError('Word missing from dictionary')
 * 
 *         wordslen = word_ids.size()             # <<<<<<<<<<<<<<
 * 
 ...
 */
    ...
    /* "baseline/pytorch/embed/corpus_cython.pyx":251
 * 
 *         # Record co-occurrences in a moving window.
 ...
 */
    ...
    for (__pyx_t_8 = 0; __pyx_t_8 < __pyx_t_7; __pyx_t_8+=1) {
      ...
      /* "baseline/pytorch/embed/corpus_cython.pyx":252
 *         # Record co-occurrences in a moving window.
 *         for i in range(wordslen):
 *             outer_word = word_ids[i]             # <<<<<<<<<<<<<<
 * 
 ...
 */
      ...
      /* "baseline/pytorch/embed/corpus_cython.pyx":255
 * 
 *             # Continue if we have an OOD token.
 *             if outer_word == -1:             # <<<<<<<<<<<<<<
 *                 continue
 ...
 */
      ...
      if (__pyx_t_5) {
        ...
        /* "baseline/pytorch/embed/corpus_cython.pyx":256
 *             # Continue if we have an OOD token.
 *             if outer_word == -1:
 *                 continue             # <<<<<<<<<<<<<<
 * 
 ...
 */
      ...
      /* "baseline/pytorch/embed/corpus_cython.pyx":258
 *                 continue
 * 
 *             window_stop = int_min(i + window_size + 1, wordslen)             # <<<<<<<<<<<<<<
 * 
 ...
 */
      __pyx_v_window_stop = __pyx_f_8baseline_7pytorch_5embed_13corpus_cython_int_min(((__pyx_v_i + __pyx_v_window_size) + 1), __pyx_v_wordslen);

      /* "baseline/pytorch/embed/corpus_cython.pyx":260
 *             window_stop = int_min(i + window_size + 1, wordslen)
 * 
 *             for j in range(i, window_stop):             # <<<<<<<<<<<<<<
 ...
 */
      ...
      for (__pyx_t_11 = __pyx_v_i; __pyx_t_11 < __pyx_t_10; __pyx_t_11+=1) {
        ...
        /* "baseline/pytorch/embed/corpus_cython.pyx":261
 * 
 *             for j in range(i, window_stop):
 *                 inner_word = word_ids[j]             # <<<<<<<<<<<<<<
 * 
 ...
 */
        ...
        /* "baseline/pytorch/embed/corpus_cython.pyx":263
 *                 inner_word = word_ids[j]
 * 
 *                 if inner_word == -1:             # <<<<<<<<<<<<<<
 *                     continue
 ...
 */
        ...
        if (__pyx_t_5) {
          ...
          /* "baseline/pytorch/embed/corpus_cython.pyx":264
 * 
 *                 if inner_word == -1:
 *                     continue             # <<<<<<<<<<<<<<
 * 
 ...
 */
        ...
        /* "baseline/pytorch/embed/corpus_cython.pyx":267
 * 
 *                 # Do nothing if the words are the same.
 ...
 */
        ...
        if (__pyx_t_5) {
          ...
          /* "baseline/pytorch/embed/corpus_cython.pyx":268
 *                 # Do nothing if the words are the same.
 *                 if inner_word == outer_word:
 *                     continue             # <<<<<<<<<<<<<<
 * 
 ...
 */
        ...
        /* "baseline/pytorch/embed/corpus_cython.pyx":270
 *                     continue
 * 
 *                 if inner_word < outer_word:             # <<<<<<<<<<<<<<
 ...
 */
        ...
        if (__pyx_t_5) {
          ...
          /* "baseline/pytorch/embed/corpus_cython.pyx":271
 * 
 *                 if inner_word < outer_word:
 *                     increment_matrix(matrix,             # <<<<<<<<<<<<<<
 *                                      inner_word,
 *                                      outer_word,
 */
          __pyx_f_8baseline_7pytorch_5embed_13corpus_cython_increment_matrix(__pyx_v_matrix, __pyx_v_inner_word, __pyx_v_outer_word, (1.0 / (__pyx_v_j - __pyx_v_i)));
 ...
 */
        ...
        /* "baseline/pytorch/embed/corpus_cython.pyx":276
 *                                      1.0 / (j - i))
 *                 else:
 *                     increment_matrix(matrix,             # <<<<<<<<<<<<<<
 *                                      outer_word,
 ...
 */
        /*else*/ {
          ...
          /* "baseline/pytorch/embed/corpus_cython.pyx":279
 *                                      outer_word,
 *                                      inner_word,
 *                                      1.0 / (j - i))             # <<<<<<<<<<<<<<
 * 
 *     # Create the matrix.
 */
          __pyx_f_8baseline_7pytorch_5embed_13corpus_cython_increment_matrix(__pyx_v_matrix, __pyx_v_outer_word, __pyx_v_inner_word, (1.0 / (__pyx_v_j - __pyx_v_i)));
        }
        __pyx_L13:;
        __pyx_L9_continue:;
      }
 ...
 */
  ...
  /* "baseline/pytorch/embed/corpus_cython.pyx":282
 * 
 *     # Create the matrix.
 ...
 */
  ...
  __pyx_t_1 = __pyx_f_8baseline_7pytorch_5embed_13corpus_cython_matrix_to_coo(__pyx_v_matrix, __pyx_t_2); if (unlikely(!__pyx_t_1)) __PYX_ERR(0, 282, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_1);
  __pyx_v_mat = __pyx_t_1;
  __pyx_t_1 = 0;

  /* "baseline/pytorch/embed/corpus_cython.pyx":283
 *     # Create the matrix.
 *     mat = matrix_to_coo(matrix, len(dictionary))
 *     free_matrix(matrix)             # <<<<<<<<<<<<<<
 * 
 *     return mat
 */
  __pyx_f_8baseline_7pytorch_5embed_13corpus_cython_free_matrix(__pyx_v_matrix);

  /* "baseline/pytorch/embed/corpus_cython.pyx":285
 *     free_matrix(matrix)
 * 
 *     return mat             # <<<<<<<<<<<<<<
 */
...
static PyTypeObject __pyx_type___pyx_array = {
  ...
  "baseline.pytorch.embed.corpus_cython.array", /*tp_name*/
...
static PyTypeObject __pyx_type___pyx_MemviewEnum = {
  PyVarObject_HEAD_INIT(0, 0)
  "baseline.pytorch.embed.corpus_cython.Enum", /*tp_name*/
...
static PyTypeObject __pyx_type___pyx_memoryview = {
  PyVarObject_HEAD_INIT(0, 0)
  "baseline.pytorch.embed.corpus_cython.memoryview", /*tp_name*/
...
static PyTypeObject __pyx_type___pyx_memoryviewslice = {
  PyVarObject_HEAD_INIT(0, 0)
  "baseline.pytorch.embed.corpus_cython._memoryviewslice", /*tp_name*/
...
static __Pyx_StringTabEntry __pyx_string_tab[] = {
  ...
  {&__pyx_kp_s_baseline_pytorch_embed_corpus_cy, __pyx_k_baseline_pytorch_embed_corpus_cy, sizeof(__pyx_k_baseline_pytorch_embed_corpus_cy), 0, 0, 1, 0},
  {&__pyx_n_s_baseline_pytorch_embed_corpus_cy_2, __pyx_k_baseline_pytorch_embed_corpus_cy_2, sizeof(__pyx_k_baseline_pytorch_embed_corpus_cy_2), 0, 0, 1, 1},
...
if (!__Pyx_RefNanny) {
  ...
  #endif
  if (__pyx_module_is_main_baseline__pytorch__embed__corpus_cython) {
    if (PyObject_SetAttrString(__pyx_m, "__name__", __pyx_n_s_main) < 0) __PYX_ERR(0, 1, __pyx_L1_error)
  }
  #if PY_MAJOR_VERSION >= 3
  {
    PyObject *modules = PyImport_GetModuleDict(); if (unlikely(!modules)) __PYX_ERR(0, 1, __pyx_L1_error)
    if (!PyDict_GetItemString(modules, "baseline.pytorch.embed.corpus_cython")) {
      if (unlikely(PyDict_SetItemString(modules, "baseline.pytorch.embed.corpus_cython", __pyx_m) < 0)) __PYX_ERR(0, 1, __pyx_L1_error)
    }
  }
  #endif
  /*--- Builtin init code ---*/
  ...
  /* "baseline/pytorch/embed/corpus_cython.pyx":5
 ...
 */
  ...
  /* "baseline/pytorch/embed/corpus_cython.pyx":6
 * 
 * import numpy as np
 * import scipy.sparse as sp             # <<<<<<<<<<<<<<
 * 
 ...
 *     """
 */
  __pyx_t_2 = PyCFunction_NewEx(&__pyx_mdef_8baseline_7pytorch_5embed_13corpus_cython_1construct_cooccurrence_matrix, NULL, __pyx_n_s_baseline_pytorch_embed_corpus_cy_2); if (unlikely(!__pyx_t_2)) __PYX_ERR(0, 217, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_2);
  if (PyDict_SetItem(__pyx_d, __pyx_n_s_construct_cooccurrence_matrix, __pyx_t_2) < 0) __PYX_ERR(0, 217, __pyx_L1_error)
  __Pyx_DECREF(__pyx_t_2); __pyx_t_2 = 0;

  /* "baseline/pytorch/embed/corpus_cython.pyx":1
 * #!python             # <<<<<<<<<<<<<<
 ...
 */
  ...
  if (__pyx_m) {
    if (__pyx_d) {
      __Pyx_AddTraceback("init baseline.pytorch.embed.corpus_cython", 0, __pyx_lineno, __pyx_filename);
    }
    Py_DECREF(__pyx_m); __pyx_m = 0;
  } else if (!PyErr_Occurred()) {
    PyErr_SetString(PyExc_ImportError, "init baseline.pytorch.embed.corpus_cython");
  }
  __pyx_L0:;
  __Pyx_RefNannyFinishContext();
  #if CYTHON_PEP489_MULTI_PHASE_INIT
